  ...
  export default {
    ...
    methods:{
      init: function() {
        ...
        Apartment.reset().keys('id,apt_name,apt_image,estate_name,province_poi_province,city_poi_city,district_poi_district,aptt_poi_apartment_types,community_poi_communities,update_time').include('aptt_poi_apartment_types,province_poi_province,city_poi_city,district_poi_district,community_poi_communities').limit(model.pagesize).skip(skip).all((data)=> {
