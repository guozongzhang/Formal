            ...
            li.list-style.clear(v-for="item in housetype.list")
              ...
              div.subright
                ...
                p.adderss 
                  ...
                  span {{item.province_poi_province.ProvinceName}} {{item.city_poi_city.CityName}} {{item.district_poi_district.DistrictName}}-{{item.community_poi_communities ? item.community_poi_communities.community_name : '暂无'}}
